...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_menu__ = __webpack_require__(5);



const menu = new __WEBPACK_IMPORTED_MODULE_1__components_menu__["a" /* default */]() // eslint-disable-line
...
class Menu {
  ...
  setEvents () {
    ...
    window.addEventListener('scroll', __WEBPACK_IMPORTED_MODULE_0_lodash_throttle___default()(this.setMenuBackground.bind(this), 200))
  }
